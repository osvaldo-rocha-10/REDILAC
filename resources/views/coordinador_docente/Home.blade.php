     ...
     <!-- Counts Section -->
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class=""><b>EQUIPOS EN RESGUARDO</b></strong><br><br><span>Total</span>
             ...
             <div class="col-xl-3 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class=""><b>GALERIA DE EQUIPOS</b></strong><br><br><span>Total</span>
            ...
            <div class="col-xl-3 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class=""><b>FORMATOS ESPECIFICOS</b></strong><br><br><span>Total</span>
                  <div class="count-number">0</div>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class=""><b>REPORTES GENERADOS</b></strong><br><br><span>Total</span>
                      ...
                      <div class="card to-do" style="background: #003b5c; border-color: #00b5e2;  border-width: 3px;" >
                          <h2 class="display h1" style="text-align: center;  color: #00b5e2;">REDILAC-EMS</h2>
                              ...
                              <h6 class="display h6" style=" color: #00b5e2;">
                                1.- En la parte superior encontrara información general de los equipos a su resguardo, asi como, el formato de bienes por usuario e información de  reportes. <br> <br>
      ...
      <section class="statistics">
         <div class="container-fluid">
          ...
          <div class="col-lg-4" onclick="location.href='{{ route('operacion.docente') }}';">
              <!-- Income-->
