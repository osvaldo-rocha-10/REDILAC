         ...
         <div class="container-fluid">
          <div class="card shadow mb-4">
            <div class="card income"  style="border-color: #003b5c;  border-width: 2px; padding: 10px; margin: 3px;">
             ...
             <center> 2.1 EQUIPOS REGISTRADOS </center>
               <br>
               <br>

                2.1.1-Realice operaciones de editar  o  dar de baja un equipo  en la tabla de "EQUIPOS REGISTRADOS". <br>
                2.1.2-Si desea agregar un equipo de manera individual seleccione aqui   
                ...
                2.1.3.-Visualize el historial detallado por equipo (Estatus,registro,Alta,Baja y Ultima Modificación) seleccionando el No.Inventario de la tabla "Equipos Registrados". <br><br>

                2.1.4.- Para las categorias de equipo "
                ...
                2.1.5  Para restaurar un equipo en  Baja-Temporal busque  la subsección "EQUIPOS BAJA TEMPORAL" de esta misma sección. <br><br>
                2.1.6  Si desea mover la tabla busque la barra horizontal (scroll) que se encuentra al final.
