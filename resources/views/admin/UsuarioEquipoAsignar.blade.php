          ...
          <div class="card shadow mb-4">
           <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
               <center>EQUIPOS {{{$academia}}} <br>

               </center> <br>

               1.-Dar click en las casillas para agregar un equipo. <br> <br>
            ...
            @if(count($equipo)>0)
            <div class="card-body">
            <form method="post" action="{{ route('usuario.store_lista',$id_coordinador) }}" id="ue">
               @csrf
               @method('put')
                  ...
                  <tbody>
                      ...
                      @foreach ($equipo as $equipos)
                        <tr>
                            ...
                            <td><input type="checkbox" name ="equipo[]"  class="case" 
